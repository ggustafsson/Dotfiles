...
if [ $OS == "Darwin" ] ; then
	...
	alias f="open ."
	alias ls="ls -Gh"
	alias mvim="screen -S vim /Applications/MacVim.app/Contents/MacOS/Vim -g --remote-tab"
	alias o="open"
	alias ql="qlmanage -p \"$@\" >& /dev/null"
	alias rmds='find "$PWD" -name ".DS_Store" -depth -exec rm {} \;'
	alias startmpd="mpd ~/.mpd/config"
	alias stopmpd="killall mpd"
	alias vim="screen -S vim /Applications/MacVim.app/Contents/MacOS/Vim"
	alias vimdiff="screen -S vim /Applications/MacVim.app/Contents/MacOS/Vim -d"
else
	alias cal="cal -m"
	...
	alias vim="screen -S vim vim"
	alias vimdiff="screen -S vim vim -d"
...
alias lsl="ls | less"
alias mv="mv -vi"
alias ncftp="cd ~/Downloads; screen -S ncftp ncftp"
alias next="mpc next"
